...
<script>
import MsApiKeyValue from "@/views/components/api/definition/components/ApiKeyValue";
import ApiAssertions from "@/views/components/api/definition/components/assertion/ApiAssertions";
import MsApiExtract from "@/views/components/api/definition/components/extract/ApiExtract";
import ApiRequestMethodSelect from "@/views/components/api/definition/components/collapse/ApiRequestMethodSelect";
import MsCodeEdit from "@/views/components/common/components/MsCodeEdit";
import MsApiScenarioVariables from "@/views/components/api/definition/components/ApiScenarioVariables";
import {createComponent} from "@/views/components/api/definition/components/jmeter/components";
import {Assertions, Extract} from "@/views/components/api/definition/model/ApiTestModel";
import {parseEnvironment} from "@/views/components/api/definition/model/EnvironmentModel";
import ApiEnvironmentConfig from "@/views/components/api/test/components/ApiEnvironmentConfig";
import {getCurrentProjectID} from "@/common/js/utils";
import {getUUID} from "@/common/js/utils";
import MsJsr233Processor from "@/views/components/api/automation/scenario/component/Jsr233Processor";
