...
<script>
import {Scenario, TCPConfig, TCPRequest} from "@/views/components/api/test/model/ScenarioModel";
import MsApiAssertions from "@/views/components/api/test/components/assertion/ApiAssertions";
import MsApiExtract from "@/views/components/api/test/components/extract/ApiExtract";
