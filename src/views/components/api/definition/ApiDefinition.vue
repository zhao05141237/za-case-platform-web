...
import ApiDocumentsPage from "@/views/components/api/definition/components/list/ApiDocumentsPage";
...
import MockConfig from "@/views/components/api/definition/components/mock/MockConfig";
import ApiSchedule from "@/views/components/api/definition/components/import/ApiSchedule";
