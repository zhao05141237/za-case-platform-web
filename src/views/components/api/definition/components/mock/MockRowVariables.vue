...
<script>
import {KeyValue} from "@/views/components/api/test/model/ScenarioModel";
import MsApiVariableInput from "@/views/components/api/test/components/ApiVariableInput";
