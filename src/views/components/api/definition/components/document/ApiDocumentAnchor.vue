...
<script>
import {API_METHOD_COLOUR} from "@/views/components/api/definition/model/JsonData";
...
import {calculate} from "@/views/components/api/definition/model/ApiTestModel";
import MsJsonCodeEdit from "@/views/components/common/json-schema/JsonSchemaEditor";
import Api from "@/views/components/api/router";
import {uuid} from "@/common/js/utils";

const requireComponent = require.context('@/views/components/xpack/', true, /\.vue$/);
