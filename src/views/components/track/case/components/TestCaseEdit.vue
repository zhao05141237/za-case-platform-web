...
<script>
  ...
  import TestCaseAttachment from "@/views/components/track/case/components/TestCaseAttachment";
  import CaseComment from "@/views/components/track/case/components/CaseComment";
  import MsInputTag from "@/views/components/api/automation/scenario/MsInputTag";
  import MsPreviousNextButton from "../../../common/components/MsPreviousNextButton";
  import {ELEMENTS} from "@/views/components/api/automation/scenario/Setting";
  import TestCaseComment from "@/views/components/track/case/components/TestCaseComment";
  import ReviewCommentItem from "@/views/components/track/review/commom/ReviewCommentItem";
  import {API_STATUS, REVIEW_STATUS, TEST, TEST_CASE} from "@/views/components/api/definition/model/JsonData";
  import MsTableButton from "@/views/components/common/components/MsTableButton";
  import MsSelectTree from "../../../common/select-tree/SelectTree";
  import MsTestCaseStepRichText from "./MsRichText";
  import CustomFiledComponent from "@/views/components/settings/workspace/template/CustomFiledComponent";
  import {
    buildCustomFields,
  ...
  import MsFormDivider from "@/views/components/common/components/MsFormDivider";
  import TestCaseEditOtherInfo from "@/views/components/track/case/components/TestCaseEditOtherInfo";
  import FormRichTextItem from "@/views/components/track/case/components/FormRichTextItem";
  import TestCaseStepItem from "@/views/components/track/case/components/TestCaseStepItem";
  import StepChangeItem from "@/views/components/track/case/components/StepChangeItem";
