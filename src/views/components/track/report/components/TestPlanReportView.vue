...
<script>
  ...
  import BaseInfoComponent
    from "@/views/components/track/plan/view/comonents/report/TemplateComponent/BaseInfoComponent";
  import TestResultChartComponent
    from "@/views/components/track/plan/view/comonents/report/TemplateComponent/TestResultChartComponent";
  import TestResultComponent
    from "@/views/components/track/plan/view/comonents/report/TemplateComponent/TestResultComponent";
  import RichTextComponent
    from "@/views/components/track/plan/view/comonents/report/TemplateComponent/RichTextComponent";
  import TestCaseReportTemplateEdit
    from "@/views/components/track/plan/view/comonents/report/TestCaseReportTemplateEdit";
  import TemplateComponent
    from "@/views/components/track/plan/view/comonents/report/TemplateComponent/TemplateComponent";
