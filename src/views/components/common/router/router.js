...
import Setting from "@/views/components/settings/router";
import API from "@/views/components/api/router";
import Performance from "@/views/components/performance/router";
import Track from "@/views/components/track/router";
