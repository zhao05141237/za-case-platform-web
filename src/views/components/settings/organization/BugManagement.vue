...
<script>
import TapdSetting from "@/views/components/settings/organization/components/TapdSetting";
import JiraSetting from "@/views/components/settings/organization/components/JiraSetting";
import ZentaoSetting from "@/views/components/settings/organization/components/ZentaoSetting";
