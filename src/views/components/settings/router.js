const requireContext = require.context('@/views/components/xpack/', true, /router\.js$/);

export default {
  path: "/setting",
  name: "Setting",
  components: {
    content: () => import('@/views/components/settings/Setting')
  },
  children: [
    {
      path: 'user',
      component: () => import('@/views/components/settings/system/User'),
      meta: {system: true, title: 'commons.user', permissions: ['SYSTEM_USER:READ']}
    },
    {
      path: 'organization',
      component: () => import('@/views/components/settings/system/Organization'),
      meta: {system: true, title: 'commons.organization', permissions: ['SYSTEM_ORGANIZATION:READ']}
    },
    {
      path: 'systemworkspace',
      component: () => import('@/views/components/settings/system/SystemWorkspace'),
      meta: {system: true, title: 'commons.workspace', permissions: ['SYSTEM_WORKSPACE:READ']}
    },
    {
      path: 'usergroup',
      component: () => import('@/views/components/settings/system/group/UserGroup'),
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/workspace/template/CustomFieldList'),
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/workspace/template/TestCaseTemplateList'),
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/workspace/template/IssuesTemplateList'),
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/workspace/template/TestCaseReportTemplate'),
      meta: {
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/system/TestResourcePool'),
      meta: {system: true, title: 'commons.test_resource_pool', permissions: ['SYSTEM_TEST_POOL:READ']}
    },
    {
      path: 'systemparametersetting',
      component: () => import('@/views/components/settings/system/SystemParameterSetting'),
    ...
    },
    {
      ...
      component: () => import('@/views/components/settings/operatinglog/OperatingLog'),
      name:'system',
